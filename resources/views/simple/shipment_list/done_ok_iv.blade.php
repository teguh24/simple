    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                ...
                <li class="active"><a href={{asset("/done/ok")}}><font face="calibri" color="black"><big><big><big>Shipment Invoice </font></big></big></big> <span class="label label-default">{{$count_ok_iv}}</span></a></li>
                <li><a href={{asset("/done/not")}}><font face="calibri" color="black">Outstanding Invoice Shipment </font> <span class="label label-danger">{{$count_nok_iv}}</span></a></li>
                </ul>
                <div class="panel-body">
                    <table id="done_iv" class="table table-bordered table-condensed dt-responsive" width="100%">
        <thead>
            <tr class="info">
            ...
            @foreach($row as $data)                
                ...
                <td>
                    <a class="btn btn-success btn-xs" href="/simple/public/show/{{$data->invoice}}" ><font face="calibri">SHOW</font></a>                    
                </td>   
            </tr>
            @endforeach
                    </table>
