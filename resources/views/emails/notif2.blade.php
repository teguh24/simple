    ...
    <td align="center" valign="top" bgcolor="#F0F0F0" style="background-color: #F0F0F0;">
      ...
      <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width:600px;max-width:600px">
        <tr>
          ...
          <div class="title" style="font-family:colonnaMT;font-size:25px;font-weight:600;color:#374550;">Daily Quota PI Besi Baja Update {{date("F j, Y, g:i a")}}</div>
          ...
          <hr>         
            <table id="quota" class="table table-hover table-bordered table-condensed dt-responsive">
                ...
                <tr class="info">                
                <th width='2%'><small>No</small></th>
                <th width='12%'><small>Pelabuhan</small></th>
                <th width='12%'><small>HS Code</small></th>
                <th width='12%'><small>Quota</small></th>                
                <th width='12%'><small>Pemakaian Quota</small></th>
                <th width='12%'><small>Sisa Quota</small></th>                
                <th width='12%'><small>Percentage Pemakaian</small></th>
                <th width='12%'><small>Sisa Percentage Quota</small></th>
            </tr>
            </thead>    
             <tbody>
                @foreach($row as $data)
